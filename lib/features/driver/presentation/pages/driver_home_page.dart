...
/// Página provisional para iniciar una solicitud de reserva.
class DriverReservePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(
        child: Text('Selecciona una celda para solicitar tu reserva.'),
      ),
    );
  }
}